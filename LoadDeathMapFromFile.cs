...
public class LoadDeathMapFromFile : MonoBehaviour
{
    ...
    public const int sBraizer = 2; //(unpathable)
    public const int sUnpathable = 3; // empty square that cannot be pathed
    ...
    public const string mapName = @"Assets/Resources/Maps/mazeMap.txt";
    ...
    public void Awake()
    {
        ...
        // load in the grass floor 
         ...
         Transform ground = Instantiate(Ground, new Vector3(mapWidth / 2, 0.0f, mapHeight / 2), Quaternion.identity);
         ground.transform.localScale = new Vector3 (mapWidth / 10, 1.0f, mapHeight / 10);

        //Transform terrain = Instantiate(Terrain, new Vector3(mapWidth / 2, -0.1f, mapHeight / 2), Quaternion.identity);
        ...
        for (int x = 0; x < mapWidth; x++)
        {
            for (int y = 0; y < mapHeight; y++)
            {
                switch (map[x, y])
                {
                    ...
                    //    break;
                    case sBraizer:
                        Instantiate(Braizer, new Vector3(x, 0, y), Quaternion.identity);                 
                        break;
                    case sCannon:
                    ...
                    case sTower:
                        ...
                        break;
                    case sResource:
                        Instantiate(Resource, new Vector3(x, 0, y), Quaternion.identity);
                        break;
                    case sAirShip:
